class RegistrationPage {
    ...
    get paswwordInput() {return cy.get('[name="password"]')};
    get submitBtn() {return cy.get('[type="submit"]')};
    get alertMessage() {return cy.get("form .MuiAlert-message")};
    get firstNameReqAlert() {return cy.get('[id=":r5:-helper-text"]')};
